...
def _build_engine_onnx(input_onnx: Union[str, bytes], force_fp16: bool = False, max_batch_size: int = 1):
    ...
    with trt.Builder(TRT_LOGGER) as builder, \
        ...
        if max_batch_size != 1:
            ...
            profile.set_shape(input_name, (max_batch_size, 3) + im_size, (max_batch_size, 3) + im_size, (max_batch_size, 3) + im_size)
...
if __name__=='__main__':
    convert_onnx("iresnet124_4.onnx","feature_4.engine",force_fp16=True,max_batch_size=4)
