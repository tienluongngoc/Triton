...
def _build_engine_onnx(input_onnx: Union[str, bytes], force_fp16: bool = False, max_batch_size: int = 1):
    ...
    with trt.Builder(TRT_LOGGER) as builder, \
        ...
        if max_batch_size != 1:
            ...
            # print(input_name, (1, im_size[1], im_size[0], 3), (max_batch_size, im_size[1], im_size[0], 3), (max_batch_size, im_size[1], im_size[0], 3))
            profile.set_shape(input_name, (max_batch_size, 3, 640, 640), (max_batch_size, 3, 640, 640), (max_batch_size, 3, 640, 640))
...
if __name__=="__main__":#iresnet18.onnx
   convert_onnx(input_onnx="scrfd_2.5g_1_640x640.onnx",engine_file_path="scrfd_2.5g_1_640x640.engine",force_fp16=True,max_batch_size=1,im_size= (640,640))