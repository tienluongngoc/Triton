...
parser.add_argument('--pretrained', help='pretrained centerface model', default='./scrfd_2.5g_1_640x640.onnx', type=str)
parser.add_argument('--input_shape', nargs='+', default=[4, 3, 640, 640], type=int, help='input shape.')
parser.add_argument('--onnx', help='onnx model', default='./scrfd_4.onnx', type=str)
